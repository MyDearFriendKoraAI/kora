...
export function SeasonSettings({ team, onUpdate }: SeasonSettingsProps) {
  ...
  const isConfigEmpty = !config.startDate && !config.endDate && config.trainingDays.length === 0;
    ...
    <div className="space-y-6">
      {isConfigEmpty ? (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">Stagione non configurata</h3>
          <p className="text-gray-600 mb-6">Configura le date e il programma allenamenti per iniziare</p>
        </div>
      ) : null}
